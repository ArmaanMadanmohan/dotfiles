...
require('lazy').setup({
...

  {
    ...
    -- Optionally specify commands for lazy loading
  },
...
-- Make line numbers relative hybrid default
...
-- Exit Terminal mode with pressing esc
...
-- local copilotChat = require("CopilotChat").setup {
